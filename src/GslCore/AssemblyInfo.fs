...
[<assembly: AssemblyVersionAttribute("0.4.35")>]
[<assembly: AssemblyFileVersionAttribute("0.4.35")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "0.4.35"
    let [<Literal>] AssemblyFileVersion = "0.4.35"
